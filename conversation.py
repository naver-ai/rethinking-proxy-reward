"""
Most code is from https://github.com/lm-sys/FastChat/blob/main/fastchat/conversation.py
"""
...
class SeparatorStyle(IntEnum):
    ...
    ADD_COLON_NO_SPACE_SINGLE = auto()
    ADD_COLON_SPACE_SINGLE = auto()
    NO_COLON_SINGLE = auto()
    NO_COLON_TWO = auto()
    NO_COLON_TWO_SPACE = auto()
...
class Conversation:
    ...
    def get_prompt(self) -> str:
        ...
        if self.sep_style == SeparatorStyle.ADD_COLON_SINGLE:
            ...
            return ret
        elif self.sep_style == SeparatorStyle.ADD_COLON_NO_SPACE_SINGLE:
            ret = self.system + self.sep
            for role, message in self.messages:
                if message:
                    ret += role + ":" + message + self.sep
...
register_conv_template(
    Conversation(
        name="almostplus",
        system="Below are a series of dialogues between a human and an AI assistant. The AI tries to be helpful, harmless, and honest.",
        roles=("\n\nHuman", "\n\nAssistant"),
        messages=(),
        offset=0,
        sep_style=SeparatorStyle.ADD_COLON_NO_SPACE_SINGLE,
        sep="",
        sep2="",
        stop_str="\nHuman:",
    )
